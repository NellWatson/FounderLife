init python:
    ...
    def draw_char(st, at): # combine the dressup items into one displayable
        return LiveComposite(
            (361, 702), # image size
            (0, 0), "dressup/base.png",
            (0, 0), "dressup/glasses%d.png"%glasses, # (0, 0) is the position of a dressup item. Because these images are saved with spacing around them, we don't need to position them.
            (0, 0), "dressup/hair%d.png"%hair,
            (0, 0), "dressup/shirt%d.png"%shirt,
            (0, 0), "dressup/tie%d.png"%tie,
            (0, 0), "dressup/pants%d.png"%pants
            ),.1
    ...
    def draw_char_side(st, at): # same thing as above, just scaled and positioned for the sideimage; there's probably more elegant solution than this...
        return LiveComposite(
            (361, 702),
            (10, 550), im.FactorScale("dressup/base.png", .45, .45),
            (10, 550), im.FactorScale("dressup/glasses%d.png"%glasses, .45, .45),
            (10, 550), im.FactorScale("dressup/hair%d.png"%hair, .45, .45),
            (10, 550), im.FactorScale("dressup/shirt%d.png"%shirt, .45, .45),
            (10, 550), im.FactorScale("dressup/tie%d.png"%tie, .45, .45),            
            (10, 550), im.FactorScale("dressup/pants%d.png"%pants, .45, .45)
            ),.1


    def draw_anon_side(st, at): # same thing as above, just scaled and positioned for the sideimage; there's probably more elegant solution than this...
        return LiveComposite(
            (324, 550),
            (10, 550), im.FactorScale("anon.png", .45, .45),
            ),.1

    def draw_vicneutral_side(st, at): # same thing as above, just scaled and positioned for the sideimage; there's probably more elegant solution than this...
        return LiveComposite(
            (324, 550),
            (10, 550), im.FactorScale("characters/vicneutral.png", 1 , 1),
            ),.1

    def draw_mattdippl_side(st, at): # same thing as above, just scaled and positioned for the sideimage; there's probably more elegant solution than this...
        return LiveComposite(
            (324, 550),
            (10, 550), im.FactorScale("characters/mattdippl.jpg", .45 , .45),
            ),.1
...
label dressup:
    ...
    python:
        ...
        y = 80
        ui.imagebutton("arrowL.png", "arrowL.png", clicked=ui.returns("hairL"), ypos=y, xpos=200)
        ui.imagebutton("arrowR.png", "arrowR.png", clicked=ui.returns("hairR"), ypos=y, xpos=600)
        y += 80
        ui.imagebutton("arrowL.png", "arrowL.png", clicked=ui.returns("glassesL"), ypos=y, xpos=200)
        ui.imagebutton("arrowR.png", "arrowR.png", clicked=ui.returns("glassesR"), ypos=y, xpos=600)
        y += 80
        ui.imagebutton("arrowL.png", "arrowL.png", clicked=ui.returns("tieL"), ypos=y, xpos=200)
        ui.imagebutton("arrowR.png", "arrowR.png", clicked=ui.returns("tieR"), ypos=y, xpos=600)
        y += 60
        ui.imagebutton("arrowL.png", "arrowL.png", clicked=ui.returns("shirtL"), ypos=y+80, xpos=200)
        ui.imagebutton("arrowR.png", "arrowR.png", clicked=ui.returns("shirtR"), ypos=y+80, xpos=600)
        y += 60
        ui.imagebutton("arrowL.png", "arrowL.png", clicked=ui.returns("pantsL"), ypos=y+160, xpos=200)
        ui.imagebutton("arrowR.png", "arrowR.png", clicked=ui.returns("pantsR"), ypos=y+160, xpos=600)
        ui.textbutton("Return", clicked=ui.returns("goback"),xpos=0.82) # image button version: ui.imagebutton("return.png", "return_hover.png", clicked=ui.returns("goback"), ypos=0, xpos=0.82)
