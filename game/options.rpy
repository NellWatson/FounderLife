...
init -1 python hide:
    ...
    config.window_title = u"Founder Life"
    
    ## For the Window Icon configuration
    
    config.window_icon = "ui/founderlifesoup.png"
    config.windows_icon = "ui/founderlifesoup.png"

    # These control the name and version of the game, that are reported
    # with tracebacks and other debugging logs.
    config.name = "Nell Watson's Founder Life"
    config.version = "0.4"
...
#        frame = "#e17373",
        ...
        mm_root = "ui/crate.png",

        ## The background of the game menu. This can be a color
        ## beginning with '#', or an image filename. The latter
        ## should take up the full height and width of the screen.
        gm_root = "ui/crate.png",
    ...
    #style.window.background = Frame("dialogboxred.png", 6, 6)
...
#    style.default.font = "DejaVuSans.ttf"
    style.default.font = "ui/Comfortaa-Regular.ttf"

    ## The default size of text.

    style.default.size = 30 #22
    ...
    style.button_text.drop_shadow = [(0, 0)]
    style.button_text.yoffset=1
    style.button_text.antialias = True
    style.button_window.top_padding=6
    style.button_text.font = "ui/Comfortaa-Light.ttf"
    ...
    config.sample_sound = "sfx/unlocked.ogg"

    ## Music that is played while the user is at the main menu.

    config.main_menu_music = "music/wholikestoparty.mp3"
...
python early:
    config.save_directory = "Founder Life-DATA"
...
init python:
    ...
    build.directory_name = "FounderLife-0.4"
    ...
    build.executable_name = "Nell Watson's Founder Life"
